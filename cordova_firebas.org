...
** Caso o projeto já exista, vou apagar pra criar de novo pra começar a aula do zero
   ...
   : 
   : [wagner@nsi_pc_149_3 ~]$ [wagner@nsi_pc_149_3 projetos]$ [wagner@nsi_pc_149_3 projetos]$ total 24
...
** Criando o projeto
   ...
   [wagner@nsi_pc_149_3 projetos]$ Creating a new cordova project.[0m
   [wagner@nsi_pc_149_3 projetos]$ total 28
   -rw-rw-r--. 1 wagner wagner  989 abr 15 14:22 config.xml
   drwxrwxr-x. 2 wagner wagner 4096 abr 15 14:22 hooks
   -rw-rw-r--. 1 wagner wagner  371 abr 15 14:22 package.json
   drwxrwxr-x. 2 wagner wagner 4096 abr 15 14:22 platforms
   drwxrwxr-x. 2 wagner wagner 4096 abr 15 14:22 plugins
   drwxrwxr-x. 4 wagner wagner 4096 abr 15 14:22 res
   drwxrwxr-x. 5 wagner wagner 4096 abr 15 14:22 www
   #+end_example
